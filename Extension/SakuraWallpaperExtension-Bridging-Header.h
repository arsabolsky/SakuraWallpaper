//
//  SakuraWallpaperExtension-Bridging-Header.h
//
//  ObjC protocol definitions matching WallpaperExtensionKit.
//  Copied from PhospheneExtension/WallpaperExtension-Bridging-Header.h —
//  these declarations are OS-level and identical for any macOS 26 wallpaper extension.
//
...
@interface NSXPCConnection (SakuraCallerIdentity)
@property (nonatomic, readonly) audit_token_t auditToken;
@end

// MARK: - Private CAContext API (for remote cross-process rendering)
